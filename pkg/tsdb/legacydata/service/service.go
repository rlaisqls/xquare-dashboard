...
import (
	...
	"github.com/xquare-dashboard/pkg/services/oauthtoken"
...
func (h *Service) HandleRequest(ctx context.Context, ds *datasources.DataSourceType, query legacydata.DataQuery) (legacydata.DataResponse, error) {
...
func (h *Service) generateRequest(ctx context.Context, ds *datasources.DataSourceType, query legacydata.DataQuery) (*backend.QueryDataRequest, error) {
