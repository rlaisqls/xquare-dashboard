...
import (
	...
	"github.com/xquare-dashboard/pkg/infra/db"
	"github.com/xquare-dashboard/pkg/infra/localcache"
	"github.com/xquare-dashboard/pkg/infra/log"
	"github.com/xquare-dashboard/pkg/plugins"
	"github.com/xquare-dashboard/pkg/plugins/config"
	pluginFakes "github.com/xquare-dashboard/pkg/plugins/manager/fakes"
	acmock "github.com/xquare-dashboard/pkg/services/accesscontrol/mock"
	"github.com/xquare-dashboard/pkg/services/datasources"
	datasourceservice "github.com/xquare-dashboard/pkg/services/datasources/service"
	...
	pluginSettings "github.com/xquare-dashboard/pkg/services/pluginsintegration/pluginsettings/service"
	"github.com/xquare-dashboard/pkg/services/pluginsintegration/pluginstore"
	"github.com/xquare-dashboard/pkg/services/quota/quotatest"
	"github.com/xquare-dashboard/pkg/services/secrets/fakes"
	secretskvs "github.com/xquare-dashboard/pkg/services/secrets/kvstore"
	secretsmng "github.com/xquare-dashboard/pkg/services/secrets/manager"
...
func TestHandleRequest(t *testing.T) {
	t.Run("Should invoke plugin manager QueryData when handling request for query", func(t *testing.T) {
		...
		ds := &datasources.DataSourceType{ID: 12, Type: "test", JsonData: simplejson.New()}
