...
import (
	...
	"github.com/xquare-dashboard/pkg/components/null"
...
type RequestHandler interface {
	...
	HandleRequest(context.Context, *datasources.DataSourceType, DataQuery) (DataResponse, error)
}
...
type DataSubQuery struct {
	...
	DataSource    *datasources.DataSourceType `json:"datasource"`
